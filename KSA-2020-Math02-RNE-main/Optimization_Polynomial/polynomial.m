...
ma2 = 10^(-14); %% 이건 Untitled 1226.m 파일에서 미리 10^(-n)들 때려넣으면서 어느정도 variation이 적당한지 감잡은 후에 설정
ma3 = 10^(-19); %% ma2, ma3, ma4 각각 2제곱항, 3제곱항, 4제곱항의 variation 단위이고
ma4 = 10^(-24); %% 처음 10^(-n) 시도후 결과보고 10^(-n-1), 10^(-n-2)로 스케일 맞춰서 더해볼것
